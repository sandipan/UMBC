...
public class MinMaxLauncher extends Configured implements Tool 
{
  String inFile;
  String outDir;
  int numMaps;
  ...
  public MinMaxLauncher(String inFile, String outDir, int numMaps, int numReduces, boolean split)
  {
	  this.inFile = inFile;
	  this.outDir = outDir;
  ...
  {
    JobConf conf = new JobConf(getConf(), MinMaxLauncher.class);
    ...
    conf.setMapperClass(split ? MinMaxSCalculatorMapper.class : MinMaxCalculatorMapper.class);
    //conf.setCombinerClass(MinMaxCalculatorReducer.class); 
    conf.setReducerClass(MinMaxCalculatorReducer.class);
